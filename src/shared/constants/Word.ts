export const WORD_DICTIONARY = [
    ...
    },
    {
        word: 'quilt',
        hints: [
            { id: 'quilt-hint-1', label: 'Bedding made of layers' },
            { id: 'quilt-hint-2', label: 'Stitched together' },
            { id: 'quilt-hint-3', label: 'Often decorative and functional' },
            { id: 'quilt-hint-4', label: 'Can be a family heirloom' },
        ],
    },
    {
        word: 'jewel',
    ...
    },
    {
        word: 'mossy',
        hints: [
            { id: 'mossy-hint-1', label: 'Covered with moss' },
            { id: 'mossy-hint-2', label: 'Indicates dampness' },
            { id: 'mossy-hint-3', label: 'Often found in forests' },
            { id: 'mossy-hint-4', label: 'Gives a green carpet look' },
        ],
    },
    {
        word: 'lunar',
        hints: [
            { id: 'lunar-hint-1', label: 'Related to the moon' },
            { id: 'lunar-hint-2', label: 'Used in the term lunar landing' },
            { id: 'lunar-hint-3', label: 'Opposite of solar' },
            { id: 'lunar-hint-4', label: 'Affects tides on Earth' },
        ],
    },
    {
        word: 'kneel',
        hints: [
            { id: 'kneel-hint-1', label: 'To bend the knee to the ground' },
            { id: 'kneel-hint-2', label: 'Symbol of submission or respect' },
            { id: 'kneel-hint-3', label: 'Common in religious practices' },
            { id: 'kneel-hint-4', label: 'Used in proposals' },
        ],
    },
    {
        word: 'ivory',
        hints: [
            { id: 'ivory-hint-1', label: 'Hard white material' },
            { id: 'ivory-hint-2', label: 'Made from tusks' },
            { id: 'ivory-hint-3', label: 'Used in art and jewelry' },
            { id: 'ivory-hint-4', label: 'Controversial due to poaching' },
        ],
    },
    {
        word: 'humor',
    ...
    },
    {
        word: 'creek',
        hints: [
            { id: 'creek-hint-1', label: 'Small stream of water' },
            { id: 'creek-hint-2', label: 'Often found in forests' },
            { id: 'creek-hint-3', label: 'Smaller than a river' },
            { id: 'creek-hint-4', label: 'Can be a habitat for wildlife' },
        ],
    },
    {
        word: 'shard',
    ...
    },
    {
        word: 'glint',
        hints: [
            { id: 'glint-hint-1', label: 'A brief flash of light' },
            { id: 'glint-hint-2', label: 'Seen on reflective surfaces' },
            {
                id: 'glint-hint-3',
                label: 'Can indicate something valuable or shiny',
            },
            {
                id: 'glint-hint-4',
                label: 'Used to describe eyes with a lively expression',
            },
        ],
    },
    {
        word: 'thorn',
        hints: [
            { id: 'thorn-hint-1', label: 'Sharp, pointed spike on a plant' },
            { id: 'thorn-hint-2', label: 'Can cause pain when touched' },
            { id: 'thorn-hint-3', label: 'Found on roses and other plants' },
            {
                id: 'thorn-hint-4',
                label: 'Symbolizes difficulty or defense in nature',
            },
        ],
    },
    {
        word: 'woven',
        hints: [
            { id: 'woven-hint-1', label: 'Made by interlacing threads' },
            { id: 'woven-hint-2', label: 'Describes fabric or baskets' },
            { id: 'woven-hint-3', label: 'Opposite of knitted' },
            { id: 'woven-hint-4', label: 'Can be done by hand or on a loom' },
        ],
    },
    {
        word: 'cloak',
    ...
    },
    {
        word: 'brink',
        hints: [
            { id: 'brink-hint-1', label: 'Edge of a steep place' },
            {
                id: 'brink-hint-2',
                label: 'On the verge of something, often used metaphorically',
            },
            {
                id: 'brink-hint-3',
                label: 'Associated with danger or critical situations',
            },
            {
                id: 'brink-hint-4',
                label: 'Can refer to a crucial or decisive point',
            },
        ],
    },
    {
        word: 'flask',
        hints: [
            { id: 'flask-hint-1', label: 'Container for liquids' },
            { id: 'flask-hint-2', label: 'Often made of glass or metal' },
            { id: 'flask-hint-3', label: 'Used for carrying beverages' },
            { id: 'flask-hint-4', label: 'Can keep drinks hot or cold' },
        ],
    },
    {
        word: 'heath',
        hints: [
            {
                id: 'heath-hint-1',
                label: 'A tract of open and uncultivated land',
            },
            {
                id: 'heath-hint-2',
                label: 'Often covered with heather and shrubs',
            },
            { id: 'heath-hint-3', label: 'Found in upland areas' },
            { id: 'heath-hint-4', label: 'Can be a habitat for wildlife' },
        ],
    },
    {
        word: 'mirth',
        hints: [
            { id: 'mirth-hint-1', label: 'Amusement or laughter' },
            {
                id: 'mirth-hint-2',
                label: 'Can be expressed with smiles or laughter',
            },
            { id: 'mirth-hint-3', label: 'Associated with joy or festivities' },
            { id: 'mirth-hint-4', label: 'Often found in social gatherings' },
        ],
    },
    {
        word: 'moose',
    ...
    },
    {
        word: 'quill',
        hints: [
            { id: 'quill-hint-1', label: 'A feather pen' },
            { id: 'quill-hint-2', label: "Porcupine's sharp spine" },
            { id: 'quill-hint-3', label: 'Used for writing in the past' },
            { id: 'quill-hint-4', label: 'Calligraphy tool' },
        ],
    },
    {
        word: 'sleet',
        hints: [
            { id: 'sleet-hint-1', label: 'Form of winter precipitation' },
            { id: 'sleet-hint-2', label: 'Frozen raindrops' },
            {
                id: 'sleet-hint-3',
                label: 'Slippery when it accumulates on surfaces',
            },
            { id: 'sleet-hint-4', label: 'Combination of rain and snow' },
        ],
    },
    {
        word: 'smoke',
    ...
    },
    {
        word: 'hoard',
        hints: [
            { id: 'hoard-hint-1', label: 'To accumulate and store away' },
            { id: 'hoard-hint-2', label: 'A hidden stock or supply' },
            { id: 'hoard-hint-3', label: 'Collected items, often valuable' },
            {
                id: 'hoard-hint-4',
                label: 'Behavior seen in animals and humans',
            },
        ],
    },
    {
    ...
    },
    {
        word: 'jolly',
        hints: [
            { id: 'jolly-hint-1', label: 'Full of high spirits' },
            { id: 'jolly-hint-2', label: 'Cheerful and lively' },
            { id: 'jolly-hint-3', label: 'To promote good cheer' },
            {
                id: 'jolly-hint-4',
                label: 'Santa Claus is often described as such',
            },
        ],
    },
    {
        word: 'knack',
        hints: [
            { id: 'knack-hint-1', label: 'A special skill or talent' },
            { id: 'knack-hint-2', label: 'Ability to do something easily' },
            {
                id: 'knack-hint-3',
                label: 'A clever or skillful way of doing something',
            },
            { id: 'knack-hint-4', label: 'Often seems effortless' },
        ],
    },
    {
        word: 'latch',
    ...
    },
    {
        word: 'mossy',
        hints: [
            { id: 'mossy-hint-1', label: 'Covered with or resembling moss' },
            {
                id: 'mossy-hint-2',
                label: 'Suggestive of the softness or texture of moss',
            },
            {
                id: 'mossy-hint-3',
                label: 'Often found in damp or shaded areas',
            },
            { id: 'mossy-hint-4', label: 'Gives a green, velvety appearance' },
        ],
    },
    {
        word: 'nudge',
        hints: [
            { id: 'nudge-hint-1', label: 'A slight push or shake' },
            { id: 'nudge-hint-2', label: 'To coax or gently persuade' },
            { id: 'nudge-hint-3', label: 'A prod to attract attention' },
            { id: 'nudge-hint-4', label: 'Used to prompt action or reaction' },
        ],
    },
    {
        word: 'opera',
